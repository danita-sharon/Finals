...
$db   = 'if0_40722582_lash_nouveau_db';      // UPDATE this to your actual database name
$user = 'if0_40722582';              // UPDATE this to your actual database user
$pass = 'danita0sharon0';          // UPDATE this to your actual database password
$charset = 'utf8mb4';
